...
public class ProductDto {
    ...
    public ProductDto(String categoryId, String name, Long total, String description, Double importPrice, Double sellingPrice, String weight, String productDiscountId, MultipartFile avatar, MultipartFile avatar1, MultipartFile avatar2) {
